...
#    "set_parameter RESTRICT_TO_MAXDSP" : [bool, [], False],
    ...
    "set_operation_latency altfp_add_8" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_add_16" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_add_32" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_add_64" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_subtract_8" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_subtract_16" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_subtract_32" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_subtract_64" : [int, [0, 16], [], 14],
    "set_operation_latency altfp_multiply_8" : [int, [0, 16], [], 11],
    "set_operation_latency altfp_multiply_16" : [int, [0, 16], [], 11],
    "set_operation_latency altfp_multiply_32" : [int, [0, 16], [], 11],
    "set_operation_latency altfp_multiply_64" : [int, [0, 16], [], 11],
    "set_operation_latency altfp_divide_8" : [int, [0, 34], [], 33],
    "set_operation_latency altfp_divide_16" : [int, [0, 34], [], 33],
    "set_operation_latency altfp_divide_32" : [int, [0, 34], [], 33],
